...
import {Card, Button, Container} from 'react-bootstrap'
 ...
 function Post() {
   ...
   <input  variant="primary" type="file" onChange={(e)=>getMedia(URL.createObjectURL(e.target.files[0]))}></input>
    ...
    <img src={(media)} height="250px" width="300px" style={{display:media?'block':'none'}}></img>      
    </div>
